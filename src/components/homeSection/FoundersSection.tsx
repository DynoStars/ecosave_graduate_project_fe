...
const founders = [
  {
    ...
    description: "Cựu đồng sáng lập của DynoStars. Nhân viên ban đầu tại Spotify và EcoSave.",
    image: founderGiaBao,
  },
  {
    id: 2,
  ...
  return (
    <section className="py-16 text-center">
      ...
      <p className="text-gray-600 mt-4 max-w-3xl mx-auto">
        Chúng tôi là một đội ngũ sáng tạo và đam mê, luôn nỗ lực mang đến những giải pháp tối ưu và sáng tạo nhất,
        kết hợp sự chuyên nghiệp và tinh thần hợp tác để đạt được những thành công bền vững.
      </p>
      ...
      <div className="grid md:grid-cols-4 gap-6 mt-10 px-4">
        {founders.map((founder) => (
          ...
          >
            ...
            <p className="text-gray-600 text-sm mt-2">{founder.description}</p>
