  ...
  return (
    <div className="bg-white rounded-lg w-full max-w-lg">
      {storeNotifications.length === 0 ? (
        ...
        <ul>
          {storeNotifications.map(({ store, products }) => (
              ...
              {expandedStores[store.id] && (
                <ul className="mt-3 space-y-2">
                  {products.map((product) => (
                    ...
                    >
                      <Link href={`/products/${product.id}`} className="flex gap-3 items-center w-full">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex gap-2 items-center text-sm">
                            Từ <span>{formatCurrency(product.original_price)}</span> giảm còn <span className="font-semibold text-red-500">{formatCurrency(product.discounted_price)}</span>
                          </div>
